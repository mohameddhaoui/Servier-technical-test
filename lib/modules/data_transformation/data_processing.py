...
import json
import re
from config import TITLE_COLUMN_NAME, MENTIONS_SOURCES, EXPOSITION_ZONE_DIRECTORY
...
def run_drugs_mentions_collection_persource(data_prep_output:dict,list_drugs:list, mentions_source:str ="pubmed"):
    """
